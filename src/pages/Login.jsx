...
const Login = () => {
  ...
  const login = () => {
    ...
    <div class="relative m-auto px-6 text-gray-500 md:px-12 xl:px-40">
        <div class="m-auto md:w-8/12 lg:w-6/12 xl:w-6/12">
            <div class="rounded-xl bg-white shadow-xl">
                <div class="p-6 sm:p-16">
                    <div class="space-y-4">
                        <img src={require('./logo.png')} loading="lazy" width="100" alt="tailus logo"/>
                        <h2 class="mb-8 text-2xl text-cyan-900 font-bold">Sign in to unlock the <br/> best of Et-Homes.</h2>
                    </div>
                    <div class="mt-16 grid space-y-4">
                       
                        <button onClick={login}class="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 
